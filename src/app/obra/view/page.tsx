          ...
          {!isAuthorized ? (
            <Card className="w-full bg-white rounded-[3.5rem] shadow-2xl border-none overflow-hidden pb-4 relative mt-10">
              <div className="bg-[#0a3d62] p-10 pt-16 text-center text-white relative">
                 ...
                 <h2 className="font-black text-xl uppercase tracking-widest">Documentación Restringida</h2>
                 <p className="text-[10px] uppercase font-black tracking-widest text-[#0a3d62] bg-primary px-4 py-2 mt-4 rounded-full absolute top-[100%] left-1/2 -translate-x-1/2 -translate-y-1/2 border-4 border-white whitespace-nowrap shadow-lg">Requiere Identificación</p>
              </div>
              <CardContent className="p-10 pt-16 space-y-6">
                <form onSubmit={async (e) => {
                  ...
                  <Button type="submit" disabled={isAuthenticating} className="w-full h-16 bg-primary hover:bg-primary/90 text-[#0a3d62] font-black text-xl gap-3 mt-6 rounded-[2rem] shadow-xl shadow-primary/30 transition-all active:scale-95">
                     {isAuthenticating ? <Loader2 className="w-6 h-6 animate-spin" /> : 'DESBLOQUEAR PLANOS'}
                  </Button>
                </form>
              </CardContent>
            </Card>
