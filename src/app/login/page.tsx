    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2 font-bold uppercase tracking-widest text-[10px]">Gestión Técnica de Obras | v2.6</p>
        </div>
        ...
        <p className="text-center text-[10px] text-muted-foreground uppercase tracking-[0.3em] font-black opacity-50">
          © {new Date().getFullYear()} Tamer Industrial S.A. | v2.6
        </p>
      </div>
    </div>
  );
